    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            while True:
                ...
                _, defender_loss_val, summary_val, global_step_val, learning_rate_val = sess.run([defender_op, defender_loss, summary, global_step, learning_rate])
                ...
                if global_step_val % num_steps_to_show_loss == 0:
                    ...
                    print('=> %s: step %d, loss = %f (%.1f examples/sec)' % (
                        datetime.now(), global_step_val, defender_loss_val, examples_per_sec))
                ...
                if accuracy > best_accuracy:
                    defender_saver.save(sess, os.path.join(path_to_train_log_dir, 'attacker_best.ckpt'))
                    patience = initial_patience
